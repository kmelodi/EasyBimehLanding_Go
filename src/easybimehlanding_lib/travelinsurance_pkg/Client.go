 ...
 */
type TRAVELINSURANCE_IMPL struct {
 ...
 * @return	Returns the *models_pkg.BaseModelTravelInsurance response from the API call
 */
func (me *TRAVELINSURANCE_IMPL) GetTravelInsurance (
    ...
    _pathUrl := "/TravelInsurance/Initialize"
   ...
   _queryBuilder = _queryBuilder + _pathUrl
    ...
    var retVal *models_pkg.BaseModelTravelInsurance = &models_pkg.BaseModelTravelInsurance{}
