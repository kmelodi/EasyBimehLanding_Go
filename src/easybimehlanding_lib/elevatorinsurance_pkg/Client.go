 ...
 */
type ELEVATORINSURANCE_IMPL struct {
 ...
 * @return	Returns the *models_pkg.BaseModelElevatorInsurance response from the API call
 */
func (me *ELEVATORINSURANCE_IMPL) GetElevatorInsurance (
    ...
    _pathUrl := "/ElevatorInsurance/Initialize"
   ...
   _queryBuilder = _queryBuilder + _pathUrl
    ...
    var retVal *models_pkg.BaseModelElevatorInsurance = &models_pkg.BaseModelElevatorInsurance{}
