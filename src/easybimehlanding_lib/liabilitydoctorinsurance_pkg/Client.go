 ...
 */
type LIABILITYDOCTORINSURANCE_IMPL struct {
 ...
 * @return	Returns the *models_pkg.BaseModelLiabilityDoctorInsurance response from the API call
 */
func (me *LIABILITYDOCTORINSURANCE_IMPL) GetLiabilityDoctorInsurance (
    ...
    _pathUrl := "/LiabilityDoctorInsurance/Initialize"
   ...
   _queryBuilder = _queryBuilder + _pathUrl
    ...
    var retVal *models_pkg.BaseModelLiabilityDoctorInsurance = &models_pkg.BaseModelLiabilityDoctorInsurance{}
...
func (me *LIABILITYDOCTORINSURANCE_IMPL) GetMedicalSpecialties (
   ...
   _queryBuilder = _queryBuilder + _pathUrl
    ...
    //returning the response
    var retVal *models_pkg.BaseModelMedicalSpecialties = &models_pkg.BaseModelMedicalSpecialties{}
    err = json.Unmarshal(_response.RawBody, &retVal)
