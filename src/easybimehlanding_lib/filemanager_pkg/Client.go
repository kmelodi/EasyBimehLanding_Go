 ...
 * @return	Returns the *models_pkg.BaseModelUpload response from the API call
 */
func (me *FILEMANAGER_IMPL) Upload (
   ...
   _queryBuilder = _queryBuilder + _pathUrl
    ...
    var retVal *models_pkg.BaseModelUpload = &models_pkg.BaseModelUpload{}
